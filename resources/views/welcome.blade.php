...
<header class="text-[Montserrat] bg-[#EDE6E0] border-b border-b-[#3d3d3d] fixed w-full">
    <nav class="flex justify-between items-center mx-1 p-4 w-full">
        <h2 class="logo cursor-pointer whitespace-nowrap">Alabaster & Ochre</h2>
        <ul class="flex space-x-1 items-center text-[clamp(0.8rem,3vw,1rem)] whitespace-nowrap">
...
<footer class="bg-[#EDE6E0] py-6 "> 
    <p class="text-center text-[#6b6b6b]"> © 2026 Alabaster & Ochre. All rights reserved.</p>
    <p class="text-center text-[#6b6b6b]">Developed by Stevie Owen </p>
</footer>
